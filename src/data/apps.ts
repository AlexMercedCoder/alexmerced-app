...
export const apps: AppEntry[] = [
  ...
  },
  {
    ...
    category: 'make',
    name: 'Tessera',
    tagline: 'Make QR codes, and read them back',
    description:
      'Nine kinds of payload, from a plain link to a Wi-Fi network or a contact card, encoded to the ISO standard by an encoder written for this site. It reads codes too: point the camera at one, or drop in a photograph, and it will straighten the perspective, repair the damaged parts, and tell you what it says before you follow it anywhere.',
    action: 'Open Tessera',
    theme: 'tessera',
    accent: '#6b4bc4',
    accentSoft: '#e8e3f7',
    storage: 'IndexedDB and localStorage',
    features: [
      'Nine payload kinds, with the raw text always shown',
      'Reads codes from the camera, a file, or a pasted screenshot',
      'Corrects perspective and repairs damage with Reed-Solomon',
      'Says what a code contains, and refuses to make a risky payload clickable',
    ],
    keywords: ['qr code generator', 'qr code reader', 'qr scanner', 'read qr from image', 'wifi qr code'],
  },
  {
    slug: 'rostrum',
    category: 'make',
